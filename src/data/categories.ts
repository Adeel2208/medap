export interface Product {
  name: string
  /** Manufacturer / principal brand, e.g. 'General Meditech Inc.' */
  brand?: string
...
// Product photography lives in /public/products/<category-id>/ and was supplied
// by MEDAP. Products without an `image` render a branded icon panel rather than
// a broken image, so the grid stays clean until a photo is added.
...
export const categories: Category[] = [
  {
    ...
    image: '/products/operation-theatre/ot-light.png',
    products: [
      {
        name: 'Operation Theatre Table',
        brand: 'Saikang Medical',
        image: '/products/operation-theatre/ot-table.png',
      },
      {
      ...
      },
      {
        ...
        brand: 'Bicakcilar, Turkey',
        model: 'Vaculine Maxi',
        image: '/products/operation-theatre/suction-unit.png',
      },
      {
        name: 'Stretcher Trolley',
        brand: 'Jiangsu Yongfa / Saikang Medical',
        image: '/products/hospital-furniture/stretcher-trolley.jpeg',
      },
      {
        name: 'Video Laryngoscope',
        brand: 'Coreray Medical / HugeMed',
        model: 'CR-31 · VL3R · CL4R',
        image: '/products/operation-theatre/video-laryngoscope.png',
      },
      {
        name: 'Video Bronchoscope',
        brand: 'HugeMed',
        model: 'VL3S',
        image: '/products/operation-theatre/video-bronchoscope.jpeg',
      },
      {
        name: 'X-Ray Illuminators with LED',
        brand: 'Micare',
        image: '/products/operation-theatre/xray-illuminator.png',
      },
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: 'Syringe Pumps',
        brand: 'Shenzhen Medrena Biotech',
        model: 'SP50 / SP50 Pro',
        image: '/products/intensive-care/syringe-pump.png',
      },
      {
        name: 'Infusion Pumps',
        brand: 'Shenzhen Medrena Biotech',
        model: 'VP50 / VP50 Pro',
        image: '/products/intensive-care/infusion-pump.png',
      },
      {
        name: 'Defibrillator with AED',
        brand: 'Amoul Medical',
        model: 'i2 / i6',
        image: '/products/intensive-care/defibrillator-aed.jpeg',
      },
      {
        name: 'ECG Machine 3/6/12 Channels',
        brand: 'Shenzhen Biocare Bio-Medical',
        image: '/products/intensive-care/ecg-machine.png',
      },
      {
        name: 'ICU Beds (3 / 5 Function)',
        brand: 'Jiangsu Yongfa / Saikang Medical',
        image: '/products/intensive-care/icu-bed.png',
      },
      {
        name: 'Blood Warmer',
        brand: 'Keewell China',
        image: '/products/intensive-care/blood-warmer.jpeg',
      },
      {
        name: 'Stethoscopes',
        brand: 'Bokang Medical',
        image: '/products/intensive-care/stethoscope.jpeg',
      },
      {
        name: 'Suction Units',
        brand: 'Bicakcilar, Turkey',
      ...
      },
      {
        name: 'Dialysis Chair',
        brand: 'Jiangsu Yongfa / Saikang Medical',
        image: '/products/hospital-furniture/dialysis-chair.jpeg',
      },
      {
        name: 'Central Monitoring System',
        brand: 'General Meditech Inc.',
        image: '/products/intensive-care/central-monitoring.png',
      },
  ...
  },
  {
    ...
    image: '/products/neonatal-nursery/infant-incubator.png',
    products: [
      {
        name: 'Infant / Baby Incubator',
        brand: 'Being Technology Inc.',
        model: 'BIN-4000B',
        image: '/products/neonatal-nursery/infant-incubator.png',
      },
      {
        name: 'Infant / Baby Warmer',
        brand: 'Being Technology Inc.',
        model: 'BRW-4000B',
        image: '/products/neonatal-nursery/infant-warmer.jpeg',
      },
      {
      ...
      {
        name: 'Neonatal Resuscitation Units',
        image: '/products/neonatal-nursery/neonatal-resuscitation.png',
      },
  ...
  },
  {
    ...
    image: '/products/obstetrics-gynecology/ctg-fetal-monitor.png',
    products: [
      {
        name: 'CTG / Fetal Monitors',
        brand: 'General Meditech Inc.',
        model: 'G6A / G6B / G6C',
        image: '/products/obstetrics-gynecology/ctg-fetal-monitor.png',
      },
      {
        name: 'Blood Pressure Apparatus',
        brand: 'Bokang Medical',
        image: '/products/obstetrics-gynecology/bp-apparatus.jpg',
      },
      ...
      {
        name: 'Gynecology Examination Tables',
        image: '/products/obstetrics-gynecology/gyne-exam-table.png',
      },
  ...
  },
  {
    ...
    image: '/products/cssd/steam-sterilizer.png',
    products: [
      {
        name: 'Steam Sterilizers',
        brand: 'Jiangsu Dengguan / Sanqiang Medical',
        image: '/products/cssd/steam-sterilizer.png',
      },
  ...
  },
  {
    ...
    image: '/products/medical-gas-pipeline/bed-head-panel.png',
    products: [
      ...
      {
        name: 'Vacuum Regulator / Venturi',
        image: '/products/medical-gas-pipeline/suction-regulator.jpeg',
      },
      ...
      {
        name: 'Medical Air Compressors',
        image: '/products/medical-gas-pipeline/air-compressor.png',
      },
      {
        name: 'Copper Pipe (All Sizes)',
        image: '/products/medical-gas-pipeline/copper-pipe.jpeg',
      },
      {
        name: 'Medical Gas Cylinders',
        brand: 'Shandong Yongan Heli Cylinder Co., Ltd',
        image: '/products/medical-gas-pipeline/gas-cylinder.jpeg',
      },
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        name: 'OT Furniture',
        brand: 'Jiangsu Yongfa / Saikang Medical',
        image: '/products/hospital-furniture/ot-table-furniture.jpeg',
      },
      ...
      { name: 'Instrument Cabinets', image: '/products/hospital-furniture/hf-instrument-cabinet.png' },
      {
        ...
        image: '/products/hospital-furniture/stainless-furniture.png',
      },
